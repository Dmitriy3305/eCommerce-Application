...
class Slider extends DOMComponent<HTMLElement> {
  ...
  public showModal(): void {
    ...
    const productData = productsRepository.getProductByKey(''); //this.productKey
    productData.then((response) => {
      const variantsProduct = response.masterData.current.masterVariant.images;
      let countVariant;
